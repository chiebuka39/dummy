        ...
        Container(
          ...
          child: SafeArea(
            child: Column(children: [
              ...
              Spacer(),
              SideMenuItem(icon: "account",
                  title: "Account Settings",top: 25,left:0.4*screenWidth,
                onTap: (){
...
class SideMenuItem extends StatelessWidget {
  ...
  const SideMenuItem({
    Key key, this.title, this.icon, this.top = 0, this.left = 200, this.color = AppColors.kWhite, this.onTap,
  }) : super(key: key);
