...
//             height: 120,
//             child: ListView.builder(itemBuilder: (context,index){
//               return FundWidgetFGN(fgnBond: fgnBond[index],selected: selected == fgnBond[index].bonds[index].id,onTap: (value){
//                 setState(() {
//                   selected = value;
//                 });
//               });
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           Text(fgnBond.tenorBandName,
//             style: TextStyle(fontSize: 15,
//                 fontFamily: "Caros-Bold", color: AppColors.kWhite),),
//           Row(
//             children: [
//               Text(fgnBond.bonds[index].,
//                 style: TextStyle(fontSize: 12,
//                     fontFamily: "Caros", color: AppColors.kLightText),),
//               Spacer(),
//               Text("",
