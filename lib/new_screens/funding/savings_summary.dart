...
class SavingsSummaryScreen extends StatefulWidget {
  ...
  const SavingsSummaryScreen({Key key, this.amount, this.savingsPlan})
      : super(key: key);
  static Route<dynamic> route({double amount, List<SavingPlanModel> savingsPlan}) {
    return MaterialPageRoute(
        builder: (_) => SavingsSummaryScreen(amount: amount, savingsPlan: savingsPlan,),
