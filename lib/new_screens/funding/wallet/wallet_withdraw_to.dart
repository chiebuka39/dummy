...
class WalletWithdrawToScreen extends StatefulWidget {
  ...
  static Route<dynamic> route() {
    return MaterialPageRoute(
        ...
        settings: RouteSettings(name: WalletWithdrawToScreen().toStringShort()));
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          YMargin(53),
          WithdrawAction(onTap: (){
            Navigator.push(context, PickSavingsPlanSceen.route());
          },),
          WithdrawAction(bg: AppColors.kSecondaryColor,
            title: "Investment Plan",onTap: (){
              Navigator.push(context, PickInvestmentPlan.route());
            },),
          YMargin(20),
          Center(child: Text("Or"),),
          WithdrawAction(title: "Bank Account",
            bg: AppColors.kPrimaryColorLight,
            textColor: AppColors.kPrimaryColor,onTap: (){
...
class WithdrawAction extends StatelessWidget {
  const WithdrawAction({
    Key key,this.title = "Savings Plan",
    this.onTap, this.bg = AppColors.kPrimaryColor, this.textColor = Colors.white,
  }) : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Spacer(),
          Icon(Icons.navigate_next_rounded,color: textColor,)
        ],),
      ),
    );
  }
