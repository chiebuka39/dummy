...
import 'package:zimvest/new_screens/navigation/investments/investment_high_yield_naira.dart';
import 'package:zimvest/new_screens/navigation/investments/invetment_high_yield_dollar_screen.dart';
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          YMargin(30),
          showInvest ? HighYieldDollarScreen() : HighYieldNairaScreen()
        ],
      ),
    );
  }
