...
class InitialReviewScreenPromissoryNote extends StatefulWidget {
  final String name;
  ...
  const InitialReviewScreenPromissoryNote(
      {Key key,
      this.name,
      this.withDrawable,
      this.transactionId,
  ...
  static Route<dynamic> route(
    ...
    return MaterialPageRoute(
      builder: (_) => InitialReviewScreenPromissoryNote(
        name: name,
      ...
      settings: RouteSettings(
        name: InitialReviewScreenPromissoryNote().toStringShort(),
      ),
    );
  }
...
class _InitialReviewScreenState
    extends State<InitialReviewScreenPromissoryNote> {
