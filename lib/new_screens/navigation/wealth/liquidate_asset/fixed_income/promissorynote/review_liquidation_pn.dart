...
class ReviewBankTransferLiquidationPromissoryNote extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransferLiquidationPromissoryNote(),
        settings: RouteSettings(
            name: ReviewBankTransferLiquidationPromissoryNote().toStringShort()));
  }
...
class _ReviewBankTransferLiquidationState
    extends State<ReviewBankTransferLiquidationPromissoryNote> {
