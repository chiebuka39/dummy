...
class InitialReviewScreenEuroBond extends StatefulWidget {
  final String name;
  ...
  const InitialReviewScreenEuroBond(
      {Key key,
      this.name,
      this.withDrawable,
      this.transactionId,
  ...
  static Route<dynamic> route(
    ...
    return MaterialPageRoute(
      ...
      settings: RouteSettings(
        name: InitialReviewScreenEuroBond().toStringShort(),
      ),
    );
  }
...
class _InitialReviewScreenState extends State<InitialReviewScreenEuroBond> {
