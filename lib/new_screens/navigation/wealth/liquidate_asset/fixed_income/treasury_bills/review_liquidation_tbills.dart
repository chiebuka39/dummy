...
class ReviewBankTransferLiquidationTreasuryBills extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransferLiquidationTreasuryBills(),
        settings: RouteSettings(
            name: ReviewBankTransferLiquidationTreasuryBills().toStringShort()));
  }
...
class _ReviewBankTransferLiquidationState
    extends State<ReviewBankTransferLiquidationTreasuryBills> {
