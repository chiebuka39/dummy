...
class ReviewBankTransferLiquidationCorporateBond extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransferLiquidationCorporateBond(),
        settings: RouteSettings(
            name: ReviewBankTransferLiquidationCorporateBond().toStringShort()));
  }
...
class _ReviewBankTransferLiquidationState
    extends State<ReviewBankTransferLiquidationCorporateBond> {
  ...
  void startAnim2(BuildContext buildContext) async {
    ...
    var result = await liquidateAssetViewModel.liquidateCorporateBond(
