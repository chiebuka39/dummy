...
class InitialReviewScreenCommercialPaper extends StatefulWidget {
  final String name;
  ...
  const InitialReviewScreenCommercialPaper(
      {Key key,
      this.name,
      this.withDrawable,
      this.transactionId,
  ...
  static Route<dynamic> route(
    ...
    return MaterialPageRoute(
      builder: (_) => InitialReviewScreenCommercialPaper(
        name: name,
      ...
      settings: RouteSettings(
        name: InitialReviewScreenCommercialPaper().toStringShort(),
      ),
    );
  }
...
class _InitialReviewScreenState extends State<InitialReviewScreenCommercialPaper> {
