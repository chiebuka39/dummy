...
class VetScreen extends StatelessWidget {
  ...
  const VetScreen({Key key, this.passed}) : super(key: key);
  static Route<dynamic> route(bool passed) {
    return MaterialPageRoute(
        builder: (_) => VetScreen(
              passed: passed,
            ),
        settings: RouteSettings(name: VetScreen().toStringShort()));
  }
...
//   static Route<dynamic> route() {
//     return MaterialPageRoute(
//         builder: (_) => PassedScreen(),
//         settings: RouteSettings(name: PassedScreen().toStringShort()));
//   }
