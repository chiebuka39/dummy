...
class ReviewBankTransfer extends StatefulWidget {
  ...
  final Bank bank;
  const ReviewBankTransfer({Key key, this.nairaWalletWithdrawal, this.bank})
      : super(key: key);
  static Route<dynamic> route({bool nairaWalletWithdrawal, Bank bank}) {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransfer(
              nairaWalletWithdrawal: nairaWalletWithdrawal,
              bank: bank,
            ),
            ...
            children: [
                                  ...
                                  ItemFader(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 30),
                                        child: Text(
                                          "Withdrawal is successful. Your Bank Account has been credit successfully",
              ...
              error == false
                  ? Container(
                      ...
                      width: size.width,
                      child: Center(
                        child: loading ? LoadingWIdget() : SizedBox(),
                      ),
                    )
                  : Container(
                      height: size.height,
...
class ReviewBankTransferLiquidation extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransferLiquidation(),
        settings: RouteSettings(
            name: ReviewBankTransferLiquidation().toStringShort()));
  }
...
class _ReviewBankTransferLiquidationState
    extends State<ReviewBankTransferLiquidation> {
  List<GlobalKey<ItemFaderState>> keys;
...
class ReviewBankTransferDollar extends StatefulWidget {
  final bool nairaWalletWithdrawal;
  final Bank bank;
  const ReviewBankTransferDollar(
      {Key key, this.nairaWalletWithdrawal, this.bank})
      : super(key: key);
  static Route<dynamic> route({bool nairaWalletWithdrawal, Bank bank}) {
    return MaterialPageRoute(
        builder: (_) => ReviewBankTransferDollar(
              nairaWalletWithdrawal: nairaWalletWithdrawal,
              bank: bank,
            ),
        settings:
            RouteSettings(name: ReviewBankTransferDollar().toStringShort()));
  }

  @override
  _ReviewBankTransferDollarState createState() =>
      _ReviewBankTransferDollarState();
}

class _ReviewBankTransferDollarState extends State<ReviewBankTransferDollar> {
  List<GlobalKey<ItemFaderState>> keys;
