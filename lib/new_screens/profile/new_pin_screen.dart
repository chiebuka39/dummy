...
class KeyboardWidget extends StatelessWidget {
  final VoidCallback oneClicked;
  final VoidCallback twoClicked;
  final VoidCallback threeClicked;
  final VoidCallback fourClicked;
  final VoidCallback fiveClicked;
  final VoidCallback sixClicked;
  final VoidCallback sevenClicked;
  final VoidCallback eightClicked;
  final VoidCallback nineClicked;
  final VoidCallback zeroClicked;
  final String pin1;
  final String pin2;
  final String pin3;
  final String pin4;

  const KeyboardWidget({Key key, this.oneClicked, this.twoClicked,
    this.threeClicked, this.fourClicked, this.fiveClicked,
    this.sixClicked, this.sevenClicked, this.eightClicked,
    this.nineClicked, this.zeroClicked, this.pin1, this.pin2,
    this.pin3, this.pin4}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Expanded(
      flex: 4,
